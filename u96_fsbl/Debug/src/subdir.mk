...
src/psu_init.o: D:/cygwin_dir/work/test_u96_ddr/test_u96_ddr.sdk/design_1_wrapper_hw_platform_0/psu_init.c
	@echo 'Building file: $<'
	@echo 'Invoking: ARM v8 gcc compiler'
	aarch64-none-elf-gcc -DARMA53_64 -Wall -O0 -g3 -I"D:\cygwin_dir\work\test_u96_ddr\test_u96_ddr.sdk\design_1_wrapper_hw_platform_0" -c -fmessage-length=0 -MT"$@" -Os -flto -ffat-lto-objects -I../../ddr_test_bsp/psu_cortexa53_0/include -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
